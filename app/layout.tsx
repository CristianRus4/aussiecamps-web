...
export const metadata: Metadata = {
  ...
  description: "74,000+ campsites, caravan parks, stays and useful road trip stops across Australia, bundled offline. Filter, save and plan the whole trip.",
  ...
  alternates: { canonical: "/", languages: { "en-AU": "/", "de-DE": "/de", "es-ES": "/es", "fr-FR": "/fr", "it-IT": "/it", "nl-NL": "/nl", "pt-PT": "/pt", "x-default": "/" } },
  openGraph: { type: "website", locale: "en_AU", siteName: "AussieCamps", title: "Australia is big. Your plan can be simple.", description: "Find 74,000+ places offline, know what is there and plan the road trip.", url: SITE_URL, images: [{ url: "/images/aussie-og.webp", width: 1200, height: 630, alt: "AussieCamps, the camping and road trip app for Australia" }] },
